...
export default function ContestDateTimeBlock(props) {
    return (
        <div className="start-end-time-container">
            ...
            <DateTimeSelector id = {1} label={'submission period begin'} date = {props.date_1 || props.date_0} setDate = {props.setDate_1} minDate = {props.date_0} />
            <DateTimeSelector id = {2} label={'voting period begin'} date = {props.date_2} setDate = {props.setDate_2} minDate = {props.date_1} />
