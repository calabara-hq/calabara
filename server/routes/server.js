...
const { discordApp, getGuildRoles } = require('./routes/discord-routes')
const { verifySignature, verifySignerIsAdmin } = require('./edcsa-auth')
...
app.get('/dashboardBatchData/*', async function (req, res, next) {
  var ens = req.url.split('/')[2];
