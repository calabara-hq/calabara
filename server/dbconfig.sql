...
create table contest_submissions (id serial, ens text, contest_hash text, created text, author text, _hash text, _url text, primary key(id), foreign key(contest_hash) references contests(_hash) on delete cascade);